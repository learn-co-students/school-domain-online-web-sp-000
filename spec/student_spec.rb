...
describe 'School' do
  ...
  describe "#add_student" do
    ...
    it 'is able to add students to different grades' do
      ...
      expect(@school.roster).to eq({10=>["AC Slater", "Jeff Baird", "Blake Johnson", "Jeff Baird", "Avi Flombaum"], 9=>["Homer Simpson"], 7=>["Blake Johnson"]})
    end
  end
  ...
  describe "#sort" do
    it 'is able to sort the students' do
      ...
      expect(@school.sort).to eq({10=> ["AC Slater", "Avi Flombaum", "Blake Johnson", "Jeff Baird"], 9=>["Bart Simpson", "Homer Simpson"], 7=>["Blake Johnson", "Jack Bauer"]})
    end
  end
end
